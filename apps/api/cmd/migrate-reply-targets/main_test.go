...
func TestBuildMigratedContent(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			want: "> 回复 [@](kungal-user:42) [#3](kungal-reply:99)\n\nnote A\n\nmain body",
		},
		{
		...
		},
		{
			...
			want: "> 回复 [@](kungal-user:7) [#2](kungal-reply:5)",
		},
		{
			...
			want: "> 回复 [@](kungal-user:10) [#1](kungal-reply:1)\n\nA\n\n> 回复 [@](kungal-user:20) [#2](kungal-reply:2)\n\nB\n\nC",
		},
		{
