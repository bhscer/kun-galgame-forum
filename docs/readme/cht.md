...
> **AI 輔助開發說明：** 本項目自 **5.1.0** 版本起使用包含但不限於 Claude Code 等 LLM 輔助工具進行 Vibe Coding。**5.0.70** 及之前版本的所有程式碼均完全由手工編寫。最後一個完全手寫的程式碼庫版本見：[v5.0.70 (commit b4ad59e)](https://github.com/KUN1007/kun-galgame-nuxt4/tree/b4ad59eb77d3eaf36d082aa528651039816e1dfa)
